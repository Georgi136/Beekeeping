      ...
      <div className="container">
        ...
        <div className="about-grid">
          <div className="about-card">
            ...
            <p>Намираме се на Кооперативния пазар в гр. Дупница, Павилион номер 5, където можете да разгледате и закупите всички необходими консумативи.</p>
          </div>
          
          <div className="about-card">
            <div className="about-icon">📦</div>
            <h3>Богат асортимент</h3>
            <p>Предлагаме пчелни кошери, рамки, восъчни основи, защитно облекло и всичко необходимо за пчеларството.</p>
          </div>
